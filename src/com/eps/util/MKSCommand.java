        ...
        if (res != null) {
            ...
            while (iterator.hasNext()) {
                ...
                if (item.getField("isActive").getValueAsString().equalsIgnoreCase("true")) {
                    ...
                    DealService.USER_MAP.put(loginId, userName);
                }
            }
        }
    }
...
//				}
    ...
    public List<Map<String, Object>> getResult(String sessionID, String suiteID, String type, List<String> filed) throws APIException {
